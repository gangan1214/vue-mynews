<template>
    <ul class="listItem">
        <template v-for="section in itemJson">
            <!-- 视频 -->
            <li v-if="section.playonlineurl" :key="section.id">
            ...
            <!-- 1张大图 -->
            <li v-else-if="section.ptitlepic" :key="section.id">
            ...
            <!-- 3张小图 -->
            <li v-else-if="section.titlepic3" :key="section.id">
            ...
            <!-- 1张小图 -->
            <li v-else-if="section.titlepic" :key="section.id">
             ...
             <!-- 文字 -->
            <li v-else-if='section.title' :key="section.id">
                <router-link :to="url(section)" class='text'>
                    <h3 v-html="section.title"></h3>
                    <list-info :json='section'></list-info>
                </router-link>
            </li>
            <li v-else-if='section.type' id="lookHere" :key="section.id">
...
export default {
  ...
  methods: {
      url(section) {
          return `/detail?classid=${section.classid}&id=${section.id}&datafrom=${section.datafrom}`
      }
  }
}
</script>
